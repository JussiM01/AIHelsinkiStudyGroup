...
\section{Joint and marginal probability density functions}

\begin{frame}{Joint and marginal probability density functions}
...
\begin{frame}{Expectation}
  ...
  propabilities (or probability density functions in continuous cases).
  \[
